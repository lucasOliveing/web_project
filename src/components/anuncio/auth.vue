...
<template>
  <div class="container-fluid mb-5">
    ...
    <button type="button mr-4" class="btn position-relative float-center" data-bs-toggle="offcanvas"
      data-bs-target="#userAds" style="text-align: center;">Adicionar Anuncio</button>
    <button type="button" class="btn position-relative float-end" id="adm"><router-link
        to="/">voltar</router-link></button>
  </div>

  <sideMenu />
  <div v-if="auth.logged&&auth.anuncios.value">
    <div v-for="(anuncio, i) in auth.anuncios.value.anuncios" :key="i" id="ads">
        ...
        <div class="row mb-5">
          ...
          <div class="col-6 border">
            ...
            <div class="row mt-3">
              ...
              <div class="col-6">
                <select id="estadoField" class="form-select mb-3" :disabled="true" :ref="stateRef(i)" placeholder="Estado"
                  aria-label="Default select example" :value="auth.anuncios.value.anuncios[i].estado">
